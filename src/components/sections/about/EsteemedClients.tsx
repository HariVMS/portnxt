      ...
      <div className="container">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {clients.map((client, idx) => (
            <div
              key={idx}
              className="bg-white h-32 rounded-3xl flex items-center justify-center p-8 border border-slate-100 grayscale hover:grayscale-0 hover:shadow-xl hover:border-transparent transition-all duration-500"
            >
