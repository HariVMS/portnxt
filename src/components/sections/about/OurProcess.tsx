...
const steps = [
  {
    title: "Discover & Map",
    description:
      "Deep-dive assessment to map current constraints against scalable architectures.",
    icon: Search,
    number: "01",
  },
  {
    ...
    description:
      "Proof-of-concept modeling and strict data governance architectures.",
    icon: PenTool,
    number: "02",
  },
  {
    ...
    description:
      "Agile sprints merging new integrations directly into existing operational hubs.",
    icon: Code2,
    number: "03",
  },
  {
    ...
    description:
      "Relentless QA, performance testing, and user adoption support.",
    icon: ClipboardCheck,
    number: "04",
  },
];
      ...
      <div className="container 2xl:max-w-[1536px] w-full">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto text-lg">
            Every solution we create and every digital innovation we develop is
            guided by a clear and structured process.
          </p>
        </div>
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className="w-24 h-24 bg-white rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.05)] flex items-center justify-center mb-8 border-4 border-slate-50 group-hover:border-primary transition-colors duration-500 relative">
                <step.icon
                  size={32}
                  className="text-slate-400 group-hover:text-primary transition-colors duration-500"
                />
