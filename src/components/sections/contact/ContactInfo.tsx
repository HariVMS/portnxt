    ...
    return (
        <div className="space-y-3 pl-0 xl:pt-15 lg:pl-10 xl:pl-8">
            ...
            <div className="flex flex-col items-start gap-0 group">
                ...
                <div>
                    <p className="text-gray-900 text-lg dark:text-slate-800">SCO. 7, IIIrd Floor, Amartex Plaza, near Vardhaman Mall, Sector 19,</p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-start gap-0 group">
                ...
                <div>
                    <div className="flex flex-col gap-1 text-slate-600 font-light">
                        ...
                        <span>Mail: sales@makelinkit.com</span>
                    </div>
                </div>
            </div>
            ...
            {/* Social Links */}
            <div className="pt-8">
                <h4 className="text-slate-800 text-[18px] mb-2 font-bold ">Social Links</h4>
