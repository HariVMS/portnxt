        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-16">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-black text-base lg:text-[16px] mb-8 leading-relaxed">
              Please fill out this form, and one of our experts will connect
              with you shortly. Ensure that the information you provide is
              accurate so we can reach you and gather the necessary details to
