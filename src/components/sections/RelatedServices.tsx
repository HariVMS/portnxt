...
const featuredServices = [
  {
    ...
    desc: "Robust and scalable websites tailored to your business.",
  },
  {
    icon: Smartphone,
  ...
  },
  {
    ...
    slug: "cloud",
    desc: "Secure and efficient cloud infrastructure.",
  },
  {
    icon: BarChart,
    ...
    <section className="py-20 bg-white">
      <div className="container">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            <span className="text-secondary-pink font-bold tracking-widest text-xs uppercase mb-2 block text-accent">
              EXPLORE MORE
            </span>
          ...
          {displayServices.map((service, idx) => (
            ...
            >
              ...
              <Link
                ...
                className="inline-flex items-center text-sm font-bold text-slate-900 group-hover:text-primary transition-colors"
              >
