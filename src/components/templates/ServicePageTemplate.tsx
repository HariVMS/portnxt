...
import { ArrowRight, CheckCircle2, Phone, Mail, MessageSquare } from "lucide-react";
    ...
    return (
        <main className="min-h-screen">
                ...
                <div className="container 2xl:max-w-[1536px]">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        <h2 className="text-black font-bold text-3xl md:text-4xl lg:text-5xl mb-6">
                            Empowering Your Business with <span className="text-[#007bfd]">{data.title}</span>
                        </h2>
                        <p className="text-slate-500 text-lg">
                            Comprehensive solutions designed to scale, innovate, and drive growth for your enterprise.
                        </p>
                    </div>
                            ...
                            >
                                <div className="flex flex-col rounded-xl p-6">
                                    <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-sm mb-6 text-[#007bfd]">
                                        {service.icon ? <service.icon size={32} /> : <CheckCircle2 size={32} />}
                                    </div>
            ...
            <section className="py-16 lg:py-24 bg-white">
                <div className="container 2xl:max-w-[1536px]">
                    <div className="mb-12">
                        <h2 className="text-3xl font-bold text-slate-900 mb-6 font-serif">Our Process</h2>
                        <p className="text-slate-600 max-w-4xl text-sm leading-relaxed">
                            In today's digital world, your website often serves as the first impression of your business. It is vital to perform well, look appealing, and provide an exceptional user experience tailored to your goals. At Makelink Innovation, our Custom Web Development Services create bespoke web solutions that are visually appealing, functional, secure, and optimized for success. We craft digital experiences that drive engagement and growth through a comprehensive and collaborative development process.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {data.process.map((step, idx) => (
                            <div key={idx} className="bg-white border rounded-xl p-8 hover:shadow-lg transition-shadow duration-300 relative overflow-hidden">
                ...
                <div className="container relative z-10 2xl:max-w-[1536px] text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-10">
                        {data.whyChooseUs.map((item, idx) => (
                            <div key={idx} className="bg-white rounded-full w-[300px] h-[300px] p-8 flex flex-col items-center justify-center shadow-2xl hover:scale-105 transition-transform duration-300 border-4 border-white/50 text-center relative z-20 group">
                ...
                <div className="container 2xl:max-w-[1000px] mx-auto bg-[#161b22] rounded-[40px] p-8 md:p-12 border border-slate-700 relative overflow-hidden shadow-2xl">
                    <div className="flex flex-col md:flex-row gap-12 items-center relative z-10">
                        <div className="w-full md:w-3/5">
                            <h2 className="text-2xl font-bold text-white mb-2">Need a Consultation?</h2>
                            <p className="text-slate-400 text-sm mb-8">Let us know your business needs, and our team will reply shortly to start the conversation.</p>

                            <form className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <input type="text" placeholder="Enter your name" className="bg-[#1f2633] border border-slate-600 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-[#007bfd]" />
                                    <input type="text" placeholder="Enter your mobile number" className="bg-[#1f2633] border border-slate-600 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-[#007bfd]" />
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <input type="email" placeholder="Enter your email address" className="bg-[#1f2633] border border-slate-600 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-[#007bfd]" />
                                    <input type="text" placeholder="Enter your business name" className="bg-[#1f2633] border border-slate-600 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-[#007bfd]" />
                                </div>
                                <textarea rows={4} placeholder="How can we help you" className="w-full bg-[#1f2633] border border-slate-600 rounded-lg px-4 py-3 text-white text-sm focus:outline-none focus:border-[#007bfd]"></textarea>

                                <div className="pt-4">
                                    <button type="submit" className="bg-[#007bfd] text-white px-8 py-3 rounded-full font-bold text-sm hover:bg-blue-600 transition-colors shadow-lg shadow-blue-500/30 flex items-center gap-2">
                    ...
                    <div className="absolute top-8 right-8 flex gap-4 text-white text-xs hidden md:flex">
                        <div className="flex items-center gap-1"><Phone size={12} className="text-[#007bfd]" /> Call us</div>
                        <div className="flex items-center gap-1"><Mail size={12} className="text-yellow-400" /> Email us</div>
                        <div className="flex items-center gap-1"><MessageSquare size={12} className="text-green-500" /> WhatsApp</div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-primary text-white relative overflow-hidden">
                ...
                <div className="container 2xl:max-w-[1536px] relative z-10 text-center">
                    ...
                    <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
                        Let's discuss how our {data.title} services can help you achieve your goals.
                    </p>
