...
import { FacebookIcon, InstagramIcon, LinkedinIcon, TwitterIcon, YoutubeIcon } from "@/Icons/Header";
...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 w-full grid grid-rows-[48px_1fr] z-50 bg-white shadow-sm font-sans">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-3">
                            <a href="tel:+919667949121" className="flex items-center gap-2 hover:text-white/80 transition-colors">
                                <span className="font-normal text-[15px] font-brandon">+91 96679 49121</span>
                            </a>
                            <span className="hidden md:inline text-white text-[18px]">|</span>

                        </div>
                        <a href="mailto:sales@portnext.com" className="flex items-center gap-2 hover:text-white/80 transition-colors">
                            <span className="font-normal text-[15px]">sales@portnext.com</span>
                        </a>
                    </div>
                    <div className="flex items-center gap-4">
                        <div className="flex items-center space-x-2">
                            {/* Social Icons - White circle bg in reference? Simplified here */}
                            <a href="#" ><span className="w-8 h-8 rounded-full flex items-center justify-center bg-white text-primary"><FacebookIcon /></span></a>
                            <a href="#" ><span className="w-8 h-8 rounded-full flex items-center justify-center bg-white text-primary"><InstagramIcon /></span></a>
                            <a href="#" ><span className="w-8 h-8 rounded-full flex items-center justify-center bg-white text-primary"><LinkedinIcon /></span></a>
                            <a href="#" ><span className="w-8 h-8 rounded-full flex items-center justify-center bg-white text-primary"><TwitterIcon /></span></a>
                            <a href="#" ><span className="w-8 h-8 rounded-full flex items-center justify-center bg-white text-primary"><YoutubeIcon /></span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Main Navigation */}
            <div className="container bg-white relative 2xl:max-w-[1536px] 2xl:h-[92px]">
                <div className="flex justify-between items-center h-full">
                    ...
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <nav className="hidden lg:flex items-center gap-5 font-bold text-[16px] tracking-normal text-slate-800 uppercase">
                            <Link href="/about-us" className="hover:text-sky-700 transition-colors ">COMPANY</Link>
                                ...
                                <div className="absolute top-full left-1/2 -translate-x-1/2 w-[900px] bg-white shadow-xl border-t-4 border-primary opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 rounded-b-xl p-8 grid grid-cols-3 gap-8 text-left normal-case">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <ul className="space-y-2 text-sm text-slate-600 font-normal">
                                            <li><Link href="/services/ui-ux-graphic-design" className="hover:text-sky-700 hover:tracking-wide transition-all">UI/UX Graphic Design</Link></li>
                                            <li><Link href="/services/cloud" className="hover:text-sky-700 hover:tracking-wide transition-all">Cloud Solutions</Link></li>
                                            <li><Link href="/services/block-chain" className="hover:text-sky-700 hover:tracking-wide transition-all">Blockchain Development</Link></li>
                                            <li><Link href="/services/devops" className="hover:text-sky-700 hover:tracking-wide transition-all">DevOps Services</Link></li>
                                            <li><Link href="/services/salesforce" className="hover:text-sky-700 hover:tracking-wide transition-all">Salesforce</Link></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <ul className="space-y-2 text-sm text-slate-600 font-normal">
                                            <li><Link href="/services/web-development" className="hover:text-sky-700 hover:tracking-wide transition-all">Web Development</Link></li>
                                            <li><Link href="/services/mobile-app-development" className="hover:text-sky-700 hover:tracking-wide transition-all">Mobile App Development</Link></li>
                                            <li><Link href="/services/ai-development" className="hover:text-sky-700 hover:tracking-wide transition-all">AI Development</Link></li>
                                            <li><Link href="/services/erp-development" className="hover:text-sky-700 hover:tracking-wide transition-all">ERP Development</Link></li>
                                            <li><Link href="/services/crm-development" className="hover:text-sky-700 hover:tracking-wide transition-all">CRM Development</Link></li>
                                            <li><Link href="/services/iot-development" className="hover:text-sky-700 hover:tracking-wide transition-all">IoT Development</Link></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <ul className="space-y-2 text-sm text-slate-600 font-normal">
                                            <li><Link href="/services/search-engine-optimization" className="hover:text-sky-700 hover:tracking-wide transition-all">SEO Optimization</Link></li>
                                            <li><Link href="/services/social-media-marketing" className="hover:text-sky-700 hover:tracking-wide transition-all">Social Media Marketing</Link></li>
                                            <li><Link href="/services/pay-per-click" className="hover:text-sky-700 hover:tracking-wide transition-all">Pay Per Click (PPC)</Link></li>
                                            <li><Link href="/services/content-marketing" className="hover:text-sky-700 hover:tracking-wide transition-all">Content Marketing</Link></li>
                                            <li><Link href="/services/email-marketing" className="hover:text-sky-700 hover:tracking-wide transition-all">Email Marketing</Link></li>
                                        </ul>
                                    </div>
                            ...
                            <Link href="/careers" className="hover:text-sky-700 transition-colors">CAREERS</Link>
                            <Link href="/blogs" className="hover:text-sky-700 transition-colors">BLOG</Link>
                            <Link href="/contact-us" className="hover:text-sky-700 transition-colors">CONTACT</Link>
                        </nav>
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            ...
                            >
                                ...
                                <span className="w-[32px] h-[32px] rounded-full flex items-center justify-center bg-white">  <GoArrowUpRight size={21} className="group-hover:rotate-45  stroke-[0.5] text-primary  transition-transform duration-500" /></span>
                            </Link>
                        </div>
                    </div>
                    {/* Mobile Menu Toggle */}
