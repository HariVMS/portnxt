...
export const metadata = {
  title: "Careers | Makelink Innovation",
...
export default function Careers() {
  return (
    <main>
      <PageHero
        title="Join our team at Makelink Innovation Pvt Ltd."
      ...
      <section id="openings" className="py-20 bg-gray-bg">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {["Senior React Developer", "Digital Marketing Specialist", "UI/UX Designer", "Node.js Backend Developer", "SEO Analyst", "Project Manager"].map((role, idx) => (
              <div key={idx} className="bg-white p-8 rounded-2xl border border-slate-100 hover:shadow-lg transition-all group cursor-pointer relative overflow-hidden">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2 truncate group-hover:text-primary transition-colors">{role}</h3>
                <p className="text-slate-500 text-sm mb-6">Full Time • On-site</p>
          ...
          <div className="mt-12 text-center text-slate-500">
            Don't see a role that fits? Email your resume to <a href="mailto:hr@makelinkit.com" className="text-primary font-bold hover:underline">hr@makelinkit.com</a>
          </div>
        </div>
      </section>
    </main>
