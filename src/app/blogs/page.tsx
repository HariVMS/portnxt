...
export const metadata = {
  title: "Blogs | Makelink Innovation",
...
const blogPosts = [
  {
    ...
    excerpt: "Cloud migration is more than just moving data; it's a strategic shift. Learn how our experts ensure a smooth transition and what you need to consider.",
  ...
  },
  {
    ...
    excerpt: "Mobile apps differ from websites in crucial ways. Discover the key features that will drive user engagement in 2026 and how to lead the market.",
  ...
  },
  {
    ...
    excerpt: "Good design is good business. Explore how UI/UX directly influences sales conversions and the essential elements that make your brand stand out.",
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {blogPosts.map((post, idx) => (
              <div key={idx} className="bg-white rounded-3xl overflow-hidden border border-slate-100 hover:shadow-2xl transition-all duration-300 group flex flex-col">
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <Link href={`#${post.slug}`} className="mt-auto inline-flex items-center text-sm font-bold text-slate-900 group-hover:text-primary transition-colors uppercase tracking-widest">
